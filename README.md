...
| 🏠 **Hestia** | Local home base. Manages the machine, files, and environment. | 🔜 Planned |
...
├── Runtime:   OpenClaw + Claude Sonnet
└── Online:    24/7
```
...
*Built with [OpenClaw](https://openclaw.ai) · Powered by Anthropic Claude · Running on Olympus*
